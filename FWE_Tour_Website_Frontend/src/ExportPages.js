...
export {default as AllTours} from "./pages/AllTours";
export {default as AllDestinations} from "./pages/AllDestinations";
export {default as DestinationDetail} from "./pages/DestinationDetail";
